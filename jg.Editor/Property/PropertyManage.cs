...
namespace jg.Editor.Property
{
    ...
    public class PropertyManage : StackPanel
    {
        ...
        ControlPropertyStage controlStage = new ControlPropertyStage();
        ControlPropertyFont controlFont = new ControlPropertyFont();
        ControlPropertyLocation controlLocation = new ControlPropertyLocation();
        ControlPropertyTransform controlTransform = new ControlPropertyTransform();
        ControlPropertyActon controlAction = new ControlPropertyActon();
        ControlPropertyTextGrid controlTextGrid = new ControlPropertyTextGrid();
        ControlPropertyTopic controlTopic = new ControlPropertyTopic();
        ControlPropertyTopicDrag controlTopicDrag = new ControlPropertyTopicDrag();


        Xceed.Wpf.Toolkit.ColorCanvas backColorCanvas = new Xceed.Wpf.Toolkit.ColorCanvas();
        Xceed.Wpf.Toolkit.ColorCanvas foreColorCanvas = new Xceed.Wpf.Toolkit.ColorCanvas();
        ...
        public PropertyManage()
        {
            ...
            foreColorCanvas.SelectedColorChanged += new RoutedPropertyChangedEventHandler<Color>(foreColorCanvas_SelectedColorChanged);
            ...
            foreach (var v in Source)
            {
                switch (((ToolboxItem)v.Content).Content.GetType().Name)
                {
                    case "ControlTextEditor":
                        ((jg.Editor.Control.ControlTextEditor)((ToolboxItem)v.Content).Content).Background = new SolidColorBrush(e.NewValue);
                        ((jg.Editor.Control.ControlTextEditor)((ToolboxItem)v.Content).Content).mainRTB.Document.Background = new SolidColorBrush(e.NewValue);
                        break;
                    default:
