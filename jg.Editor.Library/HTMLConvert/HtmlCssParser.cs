                ...
                for (int i = 0; i < styleValues.Length; i++)
                {
                    ...
                    if (styleNameValue.Length == 2)
                    {
                        ...
                        switch (styleName)
                        {
                            ...
                            case "opacity":
                                //styleValue
                                if (localProperties.ContainsKey("background-color"))
                                    localProperties["background-color"] = "#" + (styleValue == "0" ? "00" : ((int)(Convert.ToDouble(styleValue) * 255)).ToString("X") )+ localProperties["background-color"].ToString().Substring(1);
                                if (localProperties.ContainsKey("color"))
                                    localProperties["color"] = "#" +( styleValue == "0" ? "00" : ((int)(Convert.ToDouble(styleValue) * 255)).ToString("X")) + localProperties["color"].ToString().Substring(1);
                                break;
                            default:
                                break;
                        }
